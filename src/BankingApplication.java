...
public class BankingApplication {
    ...
    public BankingApplication(String name, String accNumber, double initialBalance) {
    ...
    public static void main(String[] args) {
        ...
        BankingApplication account = new BankingApplication(name, accNumber, initialBalance);
